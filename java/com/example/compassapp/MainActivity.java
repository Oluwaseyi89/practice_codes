...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (accel_read != null && magnetic_read != null) {
            float[] R = new float[9];
            float[] I = new float[9];
            boolean success_read = SensorManager.getRotationMatrix(R, I, accel_read, magnetic_read);
                if (success_read) {
                    ...
                    bearing.setText(Integer.toString(degreesInt) + (char) 0x00B0 + " to Absolute North.");
