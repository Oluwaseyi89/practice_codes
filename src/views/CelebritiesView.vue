<template>
    <div class="home-div">
        ...
        <div class="highlight-div" v-for="article in this.celebritiesNews" :key="article.newsTitle">
            <div class="time-div">
...
<script>
    ...
    export default {
        ...
        methods: {
            async getCelebritiesNews () {
                
                let data; 
                
                try{
                    data = await fetch("http://localhost:8080/api/news_category/celebrities");
                } catch (err) {
                ...
                console.log(modNews);
                this.celebritiesNews = modNews.reverse();
            },
